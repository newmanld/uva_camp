...
#  system_create_dtsi
  ...
  def exclude_unwanted_models(solr_parameters, user_parameters)
    solr_parameters[:fq] ||= []
    solr_parameters[:fq] << "#{Solrizer.solr_name("has_model", :symbol)}:\"info:fedora/afmodel:GenericFile\" OR #{Solrizer.solr_name("has_model", :symbol)}:\"info:fedora/afmodel:Collection\""
  end
